...
CREATE UNIQUE INDEX `chat_messages_provider_idx` ON `chat_messages` (`device_id`,`provider_message_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX `chat_threads_device_peer_idx` ON `chat_threads` (`device_id`,`peer_jid`);--> statement-breakpoint
CREATE INDEX `chat_threads_recent_idx` ON `chat_threads` (`device_id`,`last_message_at`);